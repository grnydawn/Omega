...
// Aliases for Kokkos dual arrays of various dimensions and types
using DualArray1DI4   = Kokkos::DualView<I4 *, MemLayout, MemSpace>;
using DualArray1DI8   = Kokkos::DualView<I8 *, MemLayout, MemSpace>;
using DualArray1DR4   = Kokkos::DualView<R4 *, MemLayout, MemSpace>;
using DualArray1DR8   = Kokkos::DualView<R8 *, MemLayout, MemSpace>;
using DualArray1DReal = Kokkos::DualView<Real *, MemLayout, MemSpace>;
using DualArray2DI4   = Kokkos::DualView<I4 **, MemLayout, MemSpace>;
using DualArray2DI8   = Kokkos::DualView<I8 **, MemLayout, MemSpace>;
using DualArray2DR4   = Kokkos::DualView<R4 **, MemLayout, MemSpace>;
using DualArray2DR8   = Kokkos::DualView<R8 **, MemLayout, MemSpace>;
using DualArray2DReal = Kokkos::DualView<Real **, MemLayout, MemSpace>;
using DualArray3DI4   = Kokkos::DualView<I4 ***, MemLayout, MemSpace>;
using DualArray3DI8   = Kokkos::DualView<I8 ***, MemLayout, MemSpace>;
using DualArray3DR4   = Kokkos::DualView<R4 ***, MemLayout, MemSpace>;
using DualArray3DR8   = Kokkos::DualView<R8 ***, MemLayout, MemSpace>;
using DualArray3DReal = Kokkos::DualView<Real ***, MemLayout, MemSpace>;
using DualArray4DI4   = Kokkos::DualView<I4 ****, MemLayout, MemSpace>;
using DualArray4DI8   = Kokkos::DualView<I8 ****, MemLayout, MemSpace>;
using DualArray4DR4   = Kokkos::DualView<R4 ****, MemLayout, MemSpace>;
using DualArray4DR8   = Kokkos::DualView<R8 ****, MemLayout, MemSpace>;
using DualArray4DReal = Kokkos::DualView<Real ****, MemLayout, MemSpace>;
using DualArray5DI4   = Kokkos::DualView<I4 *****, MemLayout, MemSpace>;
using DualArray5DI8   = Kokkos::DualView<I8 *****, MemLayout, MemSpace>;
using DualArray5DR4   = Kokkos::DualView<R4 *****, MemLayout, MemSpace>;
using DualArray5DR8   = Kokkos::DualView<R8 *****, MemLayout, MemSpace>;
using DualArray5DReal = Kokkos::DualView<Real *****, MemLayout, MemSpace>;
